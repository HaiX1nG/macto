...
import { UserOutlined, LockOutlined, PhoneOutlined, SafetyOutlined, CloseCircleOutlined } from '@ant-design/icons'
      ...
      >
        ...
        <div className="p-8 sm:p-10">
          ...
          >
            ...
            <h1 className="text-2xl font-bold text-[var(--color-text-normal)]">注册账号</h1>
            <p className="text-[var(--color-text-muted)] mt-1">创建您的 Macto 账号</p>
          </motion.div>
          ...
          >
            ...
            >
              <Input
                prefix={<PhoneOutlined className="text-[var(--color-text-muted)]" />}
                placeholder="手机号"
                className="rounded-xl h-11 login-input"
              />
            </Form.Item>
            ...
            >
              <Checkbox className="text-[var(--color-text-muted)]">
                我已阅读并同意
